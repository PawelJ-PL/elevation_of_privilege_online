...
export const fetchScoresAction = actionCreator.async<string, Record<string, number>, Error>("FETCH_SCORES")
export const resetFetchScoresStatusAction = actionCreator("RESET_FETCH_SCORES_STATUS")
